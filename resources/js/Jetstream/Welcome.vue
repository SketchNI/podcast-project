<template>
    <div>
        <div class="p-6 bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-600">
            <div class="mt-8 text-2xl dark:text-zinc-300">
                Welcome to your Jetstream application!
            </div>

            <div class="mt-6 text-gray-500 dark:text-zinc-400">
        ...
        <div class="bg-gray-200 dark:bg-zinc-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg text-gray-600 dark:text-zinc-400 leading-7 font-semibold"><a href="https://laravel.com/docs">Documentation</a>
                    </div>
                </div>
                ...
                <div class="ml-12">
                    ...
                    <a href="https://laravel.com/docs">
                        <div class="mt-3 flex items-center text-sm font-semibold text-purple-500">
                            <div>Explore the documentation</div>

                            <div class="ml-1 text-indigo-700 dark:text-purple-300">
            ...
            <div class="p-6 border-t border-gray-200 dark:border-zinc-600 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-400">
                        <path
                    ...
                    <div class="ml-4 text-lg text-gray-600 dark:text-zinc-400 leading-7 font-semibold"><a href="https://laracasts.com">Laracasts</a>
                    </div>
                </div>
            ...
            <div class="p-6 border-t border-gray-200 dark:border-zinc-600">
                <div class="flex items-center">
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-400">
                        <path
                    ...
                    <div class="ml-4 text-lg text-gray-600 dark:text-zinc-400 leading-7 font-semibold"><a href="https://tailwindcss.com/">Tailwind</a>
                    </div>
                </div>
            ...
            <div class="p-6 border-t border-gray-200 dark:border-zinc-600 md:border-l">
                <div class="flex items-center">
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-400">
                        <path
                    ...
                    <div class="ml-4 text-lg text-gray-600 dark:text-zinc-400 leading-7 font-semibold">Authentication</div>
                </div>
